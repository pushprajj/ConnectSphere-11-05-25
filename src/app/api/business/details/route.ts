...
export async function PUT(req: NextRequest) {
  try {
    ...
    const validFields = ['name', 'description', 'location', 'website', 'business_street', 'business_city', 'business_state', 'business_zip_code', 'business_country', 'contact_phone', 'contact_email', 'contact_person'];
